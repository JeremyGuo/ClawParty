...
contextBridge.exposeInMainWorld('stellacode2', {
  ...
  appendProtocolLog: (payload) => ipcRenderer.invoke('diagnostics:appendProtocolLog', payload),
  protocolLogPath: () => ipcRenderer.invoke('diagnostics:protocolLogPath'),
  revealProtocolLog: () => ipcRenderer.invoke('diagnostics:revealProtocolLog'),
  chatTraceStatus: () => ipcRenderer.invoke('diagnostics:chatTraceStatus'),
  startChatTrace: () => ipcRenderer.invoke('diagnostics:startChatTrace'),
  stopChatTrace: () => ipcRenderer.invoke('diagnostics:stopChatTrace'),
  revealChatTrace: (filePath) => ipcRenderer.invoke('diagnostics:revealChatTrace', filePath),
  ...
  previewWorkspace: (payload) => ipcRenderer.invoke('workspace:preview', payload),
  updater: {
